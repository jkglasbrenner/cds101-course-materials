...
Obtain the GitHub repository you will use to complete the mini-homework, which contains a starter file named [visualization\_by\_example.Rmd]{.monospace}.
...
Each of the below [exercises](#exercises) are to be completed in the provided spaces within your starter file [visualization\_by\_example.Rmd]{.monospace}.
