...
yawn <- readr::read_csv("http://data.cds101.com/yawn.csv")
```

## Instructions

Obtain the GitHub repository you will use to complete the mini-homework, which contains a starter file named [mythbusters.Rmd]{.monospace}.
