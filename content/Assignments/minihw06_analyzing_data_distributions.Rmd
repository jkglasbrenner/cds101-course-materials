Title: Mini-homework 6 – Analyzing data distributions
...
Obtain the GitHub repository you will use to complete the mini-homework, which contains a starter file named [analyzing\_data\_distributions.Rmd]{.monospace}.
