...
**Lab instructions link:** <https://www.cds101.com/labs/lab-03-wrangling-sales-data/>
...
2.  Knit your R Markdown document to the PDF format, export (download) the PDF file from RStudio Server, and then upload it to _Lab 3_ posting on Blackboard.
