...
**Lab instructions link:** <https://www.cds101.com/labs/lab-02-exploration-by-visualization-the-galton-dataset/>
...
2.  Knit your R Markdown document to the PDF format, export (download) the PDF file from RStudio Server, and then upload it to _Lab 2_ posting on Blackboard.
