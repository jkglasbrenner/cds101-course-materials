...
**Lab instructions link:** <https://www.cds101.com/labs/lab-04-tidying-your-dataset/>
...
2.  Knit your R Markdown document to the PDF format, export (download) the PDF file from RStudio Server, and then upload it to _Lab 4_ posting on Blackboard.
